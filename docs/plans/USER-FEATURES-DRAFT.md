...
- daily quotes are great, but needing a manual backfill is not; a table by type and date, the shape my spreadsheet has, and on its OWN page — the rail is 360 wide and holds no controls - build +1 new page or upgrade balances page allowing quick backfill/review/edit;
...
- форма транзакцій має мати суворі перевірки і гайди, бо навіть мені без старої таблички не зрозуміли що і як вибирати. Інпути мають бути залежні і там де це можна обмежувати кількість варіантів на основі інших інпутів та вибирати автоматично де це можливо (напр. тип: нарахування дивідендів/податок => джерело: нарахування);
- можливо джерело "реінвестиція" зайве, або принаймні не варто робити "реінвестиція ..." під кожен актив а звести до одного;
- показувати більше деталей у історії транзакцій (джерело як мінімум);
- поле ціль повинно давати підказку та мати перевірку;
- можливість переставляти поля котирувань для зручності (через кнопку редагувати як на інших сторінках);
- форма котирувань має мати додаткові перевірки напр. не можна додати котирування для активу якого на певно дату ще не було у портфелі (не було куплено)
