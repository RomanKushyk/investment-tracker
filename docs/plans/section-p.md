...
(W4) is untouched — these tasks sharpened W7, they did not start it. **That
gate is now MET**: W4 closed 2026-09-02 and was archived to
`../archive/plan-b/W03-W04.md` the next day, so Section P is no longer
preparation ahead of a gate — it is the work standing in front of the phase.
