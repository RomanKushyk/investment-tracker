...
- The **Total capital** card takes the toggle's 10 rather than the concentric 14:
  the two sit together as one bottom cluster and a shared radius reads as a pair.
  That one corner is knowingly not concentric with the shell.
...
| h | r | what |
| --- | --- | --- |
| 10–12 | 4 | allocation bar track and fills, `ShareBar` |
...
| 38–40 | 10 | `Button` sizes `header` and `md`, segmented-control boxes |
