# Plan C — the closed record

**Not a task list, and never implement from it.** Plan C's open questions are in [`../../plans/PLAN-OPEN.md`](../../plans/PLAN-OPEN.md); the Status table there still carries a row for every closed question, pointing at the decision that answered it. This folder holds the *detail* those rows used to sit above, moved **verbatim** on 2026-08-26 (D95).

| Question | Closed by | Where |
|---|---|---|
| O20 — separate dev and production databases | D63 | [`O20-O23.md`](O20-O23.md) |
