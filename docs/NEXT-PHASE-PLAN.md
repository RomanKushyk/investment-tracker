...
- [x] `docs/design-brief-phase-4` — import dialog (dropzone, row-error list, diff summary), CSV cards, mirror status card states, danger-zone final look.
