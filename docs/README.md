...
| `PLAN-OPEN.md` | **Plan C — open questions**, in four rounds ordered by cost of getting them wrong. Round 1 is irreversible on DSQL and blocks the migration. | **Never implement from this file.** Answer → DECISIONS entry → delete the item → file the work into PLAN-NOW or PLAN-WAITING. |
