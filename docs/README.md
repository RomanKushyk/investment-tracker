...
| `NEXT-PHASE-PLAN.md` | **The living plan** (rewritten 2026-08-11 for the cloud direction): shipped record, retired items with reasons, the four tracks startable now (N1–N4), and the work queued behind the B3 migration. Governing decisions G1–G8 with their current standing. | Tick checkboxes as you complete them; keep the Status table current; contract changes require a DECISIONS entry. |
