...
export function Portfolio() {
  ...
  return (
    <div>
      ...
      {assets.length === 0 ? (
        <div className="text-muted mb-3.5 text-[13px] leading-normal">{t.assets.empty}</div>
      ) : desktop ? (
                ...
                >
                  ...
                  {editing && (
                    <td className="py-2 pl-4">
                      <div className="animate-in fade-in slide-in-from-bottom-1 flex items-center justify-end gap-2.5 duration-300">
                        {rowActions(r.asset)}
                      </div>
                    </td>
                  )}
      ...
      {/* ONE render site, reached by both shells because it sits after the
          ...
          portfolio. */}
      {editing && (
        <div className="animate-in fade-in slide-in-from-bottom-1 mb-3.5 duration-300">
