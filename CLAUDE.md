...
- **Deployment is `docs/DEPLOYMENT.md`** — Amplify Hosting manual-deploy app fed by `.github/workflows/deploy-frontend.yml`; hosting config (SPA 200 rewrite, cache headers) is console-managed and CI has no permission to change it (see DECISIONS D15).
