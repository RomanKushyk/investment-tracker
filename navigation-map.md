...
| `/seasonality` | Seasonality | Task 6 | done — expected coupon bars project user-created bonds too (P3 `feat/fixed-yield`); **month axis + ephemeral toggle** (A41), which is where D-5 got answered |
