...
| `/transactions` | Transactions | A32 (2026-08-19) | done — the Transaction panel moved here off `/`, and the ledger is the FULL history rather than the last three. The `Entry` group holds this and `/` |
