...
- **Appearance:** "Currency" row with a light-surface ₴ UAH / $ USD segmented control (sliding thumb like the sidebar toggle); "₴/$ rate" row with a 110px right-aligned decimal input prefilled **44.83**, and beneath it (A5/D51) an outline **"Fetch rate"** button, the whole block right-aligned to the row edge; "Theme and language settings are coming later." placeholder.
