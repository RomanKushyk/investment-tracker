...
- Light surface (page/ink/muted/pos/neg/hairline only); its focus ring is the ink one, which since #92 is the app's ONLY one — the sidebar no longer overrides it.
